...
class HTML2FPDF(HTMLParser):
    ...
    def __init__(self, pdf, image_map=None):
        ...
        # times font does not support Unicode.
        # self.set_font("times", 12)
        # self.font_face = "times"  # initialize font

        # DejaVu Sans Condensed supports at least Greek, Russian, Polish, Arabic and Hebrew Unicode characters
        self.font_face = "dejavusanscondensed"  # initialize font
        self.pdf.add_font(self.font_face, '', 'DejaVuSansCondensed.ttf', uni=True)
        self.pdf.add_font(self.font_face, 'B', 'DejaVuSansCondensed-Bold.ttf', uni=True)
        self.pdf.add_font(self.font_face, 'BI', 'DejaVuSansCondensed-BoldOblique.ttf', uni=True)
        self.pdf.add_font(self.font_face, 'I', 'DejaVuSansCondensed-Oblique.ttf', uni=True)
        self.set_font(self.font_face, 12)
